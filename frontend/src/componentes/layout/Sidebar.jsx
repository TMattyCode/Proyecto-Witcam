...
const itemsSidebar = [
  ...
  { ruta: "/camaras", icono: iconoCamara, alt: "Interfaz de cámaras", permiso: PERMISOS.GESTIONAR_CAMARAS },
  {
    ruta: "/ingresos",
    icono: iconoPersonas,
    alt: "Ingresos identificados",
    permiso: PERMISOS.GESTIONAR_IDENTIDADES,
  },
  { ruta: "/observacion", icono: iconoOjo, alt: "Lista de observación", permiso: PERMISOS.GESTIONAR_IDENTIDADES },
  {
    ruta: "/configuracion",
